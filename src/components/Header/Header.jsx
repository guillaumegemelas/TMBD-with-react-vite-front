...
export default function Header({ token, handleToken }) {
  ...
  //j'ai mis token dans le tableau de dépendance pour qu'il s'actualise lorsqu'on recoit un token: au sign up ou changement de mot de passe sur page Profil
